...
public class WindowHandler_WindowsListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.Handlers.WindowHandler+WindowsListener, Microsoft.Maui", WindowHandler_WindowsListener.class, __md_methods);
	}

	public WindowHandler_WindowsListener ()
	{
		super ();
		if (getClass () == WindowHandler_WindowsListener.class) {
			mono.android.TypeManager.Activate ("Microsoft.Maui.Handlers.WindowHandler+WindowsListener, Microsoft.Maui", "", this, new java.lang.Object[] {  });
		}
	}
